...
export const Test = ({major}:any) => {
 ...
 const handleSelectAll = (courseList: { name: string }[], isAllSelected: boolean, setIsAllSelected: React.Dispatch<React.SetStateAction<boolean>>) => {
  ...
  const A_series1:{name:string; id:string; description:string;}[] = [
    {
        name: 'I&C SCI 31',
        id: 'course_31',
        description: 'Introduction to Programming',
  ...
  const A_series2:{name:string; id:string; description:string;}[] = [
    {
        name: 'I&C SCI H32',
        id: 'course_H32',
        description: 'Python Programming and Libraries (Accelerated)',
  ...
  const B_complete:{name:string; id:string; description:string;}[] = [
    {
        name: 'I&C SCI 45C',
        id: 'course_45C',
        description: 'Programming in C/C++ as a Second Language',
    ...
    <div className="uci-major-whole">
      ...
      <div className="main_container">
          ...
          <div className="sub_container">
            ...
            <hr />
            <p>A. Select one of the following series:</p>
            {A_series1.map((course) => (
                <label key={course.id} className="course-box" htmlFor={course.id}>
                  <input
                    type="checkbox"
                    id={course.id}
                  ...
                  />
                  <span className="course-textbox">{course.name} - </span>
                  <span className="course-textbox">{course.description}</span>
                </label>
              ))}
            <p>or</p>
            {A_series2.map((course) => (
            <label key={course.id} className="course-box" htmlFor={course.id}>
                <input
                type="checkbox"
                id={course.id}
                ...
                onChange={() => handleCheckboxClick(course.name)} 
                />
                <span className="course-textbox">{course.name} - {course.description}</span>
            </label>
            ))}
            <hr />
            <button
              ...
              onClick={() =>
                handleSelectAll(B_complete, lowerAllSelected, setLowerAllSelected)
              }
            >
